...
"""
Semantic layer DAO interfaces for ax-bi-core.
...
Usage:
    from axbi_core.semantic_layers.daos import (
...
from axbi_core.common.daos import BaseDAO
from axbi_core.semantic_layers.models import SemanticLayerModel, SemanticViewModel
