...
"""
Semantic layer registration decorator for AxBI.
...
Usage:
    from axbi_core.semantic_layers.decorators import semantic_layer
...
def semantic_layer(
    ...
    Example:
        from axbi_core.semantic_layers.decorators import semantic_layer
        from axbi_core.semantic_layers.layer import SemanticLayer
