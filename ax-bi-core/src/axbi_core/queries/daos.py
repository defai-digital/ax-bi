...
"""
Query Data Access Object API for ax-bi-core.

Provides query-related DAO classes that will be replaced by host implementations
during initialization.

Usage:
    from axbi_core.queries.daos import QueryDAO, SavedQueryDAO
"""

from axbi_core.common.daos import BaseDAO
from axbi_core.queries.models import Query, SavedQuery
