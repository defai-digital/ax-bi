...
"""
MCP (Model Context Protocol) tool registration for AX BI MCP server.

This module provides a decorator interface to register MCP tools with the
host application.

Usage:
    from axbi_core.mcp.decorators import tool
...
except ImportError:  # MCP extras may not be installed in ax-bi-core-only environments
...
def tool(
    ...
    *,
    ...
    Args:
        ...
        protect: Whether to require AxBI authentication (defaults to True)
    ...
    raise NotImplementedError(
        ...
        "This decorator should be replaced during AxBI startup."
    )
