...
"""
Common model API for ax-bi-core.
...
Usage:
    from axbi_core.common.models import Dataset, Database, get_session
...
class CoreModel(Model):
    ...
    This base class provides the interface contract for all AxBI models.
...
class Database(CoreModel):
    ...
    def execute(
        ...
        Example:
            from axbi_core.common.daos import DatabaseDAO
            from axbi_core.queries.types import QueryOptions, QueryStatus
