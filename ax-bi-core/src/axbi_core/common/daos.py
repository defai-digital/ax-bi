...
from axbi_core.common.models import (
    Chart,
    CoreModel,
    Dashboard,
    Database,
...
class BaseDAO(Generic[T], ABC):
    ...
    providing consistent CRUD operations across AxBI and extensions.
    """
