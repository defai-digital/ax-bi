...
This component is available in the `@ax-bi/core/components` package, which is automatically available to AX BI extensions.
...
- [Story file](https://github.com/defai-digital/ax-bi/blob/main/ax-bi-frontend/packages/superset-core/src/ui/components/Alert/Alert.stories.tsx)
- [Component source](https://github.com/defai-digital/ax-bi/blob/main/ax-bi-frontend/packages/superset-core/src/ui/components/Alert/index.tsx)
