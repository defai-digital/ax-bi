...
- **Authoring capabilities** -- use `get_authoring_capabilities` to discover the
  server's versioned chart/dashboard operations, supported upload formats, and
  limits before starting an automated workflow
