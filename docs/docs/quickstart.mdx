...
⚠️ If you get an error message like `validating superset\docker-compose-image-tag.yml: services.ax-bi-worker-beat.env_file.0 must be a string`, you need to update your version of `docker-compose`.
