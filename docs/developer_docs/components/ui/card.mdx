...
```tsx
import { Card } from '@ax-bi/ui-core/components';
```
...
Help improve it by [editing the story file](https://github.com/defai-digital/ax-bi/edit/main/ax-bi-frontend/packages/ax-bi-ui-core/src/components/Card/Card.stories.tsx).
:::
