...
| `icon` | `string` | `"https://github.com/defai-digital/ax-bi/img/ax-bi-logo-horiz.svg"` | Icon inside the button (URL or path). |

## Import

```tsx
import { IconButton } from '@ax-bi/ui-core/components';
```
...
Help improve it by [editing the story file](https://github.com/defai-digital/ax-bi/edit/main/ax-bi-frontend/packages/ax-bi-ui-core/src/components/IconButton/IconButton.stories.tsx).
:::
