...
The Loading component from AX BI's UI library.
...
Help improve it by [editing the story file](https://github.com/defai-digital/ax-bi/edit/main/ax-bi-frontend/packages/ax-bi-ui-core/src/components/Loading/Loading.stories.tsx).
:::
