...
|------|------|---------|-------------|
| `title` | `string` | `"AxBI Card Title"` | Title displayed on the card. |
| `loading` | `boolean` | `false` | Whether the card is in loading state. |
| `url` | `string` | `"/ax-bi/dashboard/births/"` | URL the card links to. |
| `imgURL` | `string` | `"https://picsum.photos/seed/ax-bi/300/200"` | Primary image URL for the card. |
...
Help improve it by [editing the story file](https://github.com/defai-digital/ax-bi/edit/main/ax-bi-frontend/packages/ax-bi-ui-core/src/components/ListViewCard/ListViewCard.stories.tsx).
:::
