...
| `superset_config.py` | Established deployment contract for operators and Docker/Kubernetes configs. |
...
| Existing `/superset/*` routes and templates | URL, embed, legacy view, and migration compatibility. |
