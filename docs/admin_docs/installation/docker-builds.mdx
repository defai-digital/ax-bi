...
- `py312`, e.g., Py312: Similar to lean but explicitly built with Python 3.12.
...
subcommand and the [docker.yml](https://github.com/defai-digital/ax-bi/blob/main/.github/workflows/docker.yml)
GitHub action.
