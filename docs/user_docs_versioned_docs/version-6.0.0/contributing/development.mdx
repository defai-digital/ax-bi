...
- running our Cypress end-to-end tests (`ax-bi-frontend/cypress-base/`)
...
[the documentation](https://superset.apache.org/developer-docs/contributing/howtos#creating-visualization-plugins), and in [this blog post](https://preset.io/blog/building-custom-viz-plugins-in-superset-v2).
