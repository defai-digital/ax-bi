...
// Ref:ax-office-frontend/src/explore/store.js
...
// Ref: ax-office-frontend/src/explore/components/ControlPanelsContainer.jsx
...
// Ref: ax-office-frontend/src/explore/components/controls/index.js
...
> extends AnyDict {
  ...
  label?:
    ...
    | ((
        ...
        // TODO: add strict `chartState` typing (see ax-office-frontend/src/explore/types)
        chartState?: AnyDict,
      ) => ReactNode);
  description?:
    | ReactNode
...
// Ref: ax-office-frontend/@superset-ui/core/components/Select/SupersetStyledSelect.tsx
...
export type CustomControlConfig<P = {}> = BaseControlConfig<ComponentType<P>> &
  // two run-time properties from ax-office-frontend/src/explore/components/Control.jsx
...
// Ref:
//  - ax-office-frontend/src/explore/components/ControlPanelsContainer.jsx
//  - ax-office-frontend/src/explore/components/ControlPanelSection.jsx
...
// Ref:
//  - ax-office-frontend/src/explore/components/ConditionalFormattingControl.tsx
