...
|-----|------|---------|-------------|
| affinity | object | `{}` |  |
| axServices.enabled | bool | `true` | Enable the AX-BI TypeScript sidecar deployment |
| axServices.image.repository | string | `"ghcr.io/defai-digital/ax-bi-services"` |  |
| axServices.image.tag | string | `nil` | Defaults to the chart appVersion when unset |
| axServices.resources | object | `{}` | Resource settings for the AX-BI TypeScript sidecar pods |
...
| image.tag | string | `nil` | Defaults to the chart appVersion when unset |
...
| mcp.enabled | bool | `true` | Enable the AX-BI MCP service deployment |
| mcp.resources | object | `{}` | Resource settings for the AX-BI MCP service pods |
