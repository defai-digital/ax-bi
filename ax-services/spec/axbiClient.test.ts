...
import { AxBIClient } from '../src/axbiClient';
...
type ClientRequest<TMethod extends keyof AxBIClient> =
  AxBIClient[TMethod] extends (
...
function requestFor<TMethod extends keyof AxBIClient>(
  _method: TMethod,
  request: unknown,
...
test('checkHealth returns AxBI status and forwards request ID', async () => {
  ...
  const client = new AxBIClient(buildConfig({}));
...
test('checkPermission posts authorization request to AxBI', async () => {
  let seenInput: RequestInfo | URL | undefined;
  let seenInit: RequestInit | undefined;
  global.fetch = async (input, init) => {
    seenInput = input;
...
test('checkPermission fails closed when AxBI cannot be reached', async () => {
  global.fetch = async () => {
...
test('checkPermission fails closed for non-success AxBI responses', async () => {
  global.fetch = async () =>
    Response.json(
      {
        contractVersion: AUTHORIZATION_CONTRACT_VERSION,
...
test('probeMetadata returns sanitized AxBI metadata summary', async () => {
  let seenInput: RequestInfo | URL | undefined;
  let seenInit: RequestInit | undefined;
  global.fetch = async (input, init) => {
    seenInput = input;
  ...
  const client = new AxBIClient(
    buildConfig({
      AXBI_INTERNAL_TOKEN: 'token-123',
      AXBI_METADATA_PATH: '/api/v1/dashboard/_info',
    }),
  );
...
test('probeMetadata reports non-success AxBI responses without parsing body', async () => {
  global.fetch = async () =>
...
test('searchAssets queries AxBI list APIs and ranks normalized results', async () => {
...
test('searchAssets records status warnings for non-json error responses', async () => {
  ...
  expect(result).toEqual({
    contractVersion: ASSET_SEARCH_CONTRACT_VERSION,
    assets: [],
    warnings: ['dashboard search returned status 504 from AxBI'],
  });
});

test('searchAssets records warnings for malformed successful AxBI list responses', async () => {
  ...
  expect(result).toEqual({
    ...
    assets: [],
    warnings: [
      'dashboard search failed: AxBI list response must include a result array',
    ],
  });
});

test('searchAssets deduplicates requested asset types before querying AxBI', async () => {
  const seenInputs: string[] = [];
...
test('searchAssets rejects invalid limits before querying AxBI', async () => {
  let fetchCalled = false;
  global.fetch = async () => {
    fetchCalled = true;
    throw new Error('unexpected fetch');
...
test('searchAssets rejects blank queries before querying AxBI', async () => {
  let fetchCalled = false;
  global.fetch = async () => {
    fetchCalled = true;
    throw new Error('unexpected fetch');
...
test('searchAssets rejects control characters before querying AxBI', async () => {
  let fetchCalled = false;
  global.fetch = async () => {
    fetchCalled = true;
    throw new Error('unexpected fetch');
...
test('searchAssets rejects overlong queries before querying AxBI', async () => {
  let fetchCalled = false;
  global.fetch = async () => {
    fetchCalled = true;
    throw new Error('unexpected fetch');
...
test('searchAssets rejects invalid request shapes before querying AxBI', async () => {
  let fetchCalled = false;
  global.fetch = async () => {
    fetchCalled = true;
    throw new Error('unexpected fetch');
...
test('searchAssets rejects extra request fields before querying AxBI', async () => {
  let fetchCalled = false;
  global.fetch = async () => {
    fetchCalled = true;
    throw new Error('unexpected fetch');
...
test('searchAssets rejects wrong request contract versions before querying AxBI', async () => {
  let fetchCalled = false;
  global.fetch = async () => {
    fetchCalled = true;
    throw new Error('unexpected fetch');
...
for (const { name, request, warning, method } of listContractVersionCases) {
  test(`${name} rejects wrong request contract versions before querying AxBI`, async () => {
    let fetchCalled = false;
    global.fetch = async () => {
      fetchCalled = true;
      throw new Error('unexpected fetch');
...
for (const { name, request, warning, method } of ownershipFlagCases) {
  test(`${name} rejects invalid ownership flags before querying AxBI`, async () => {
    let fetchCalled = false;
    global.fetch = async () => {
      fetchCalled = true;
      throw new Error('unexpected fetch');
...
test('listAnnotationLayers maps AxBI annotation layer list responses', async () => {
  let seenInput: RequestInfo | URL | undefined;
  let seenInit: RequestInit | undefined;
  global.fetch = async (input, init) => {
    seenInput = input;
...
test('listAnnotationLayers records warnings for failed AxBI responses', async () => {
  global.fetch = async () =>
    new Response('upstream timeout', {
      status: 504,
      headers: {
  ...
  expect(result).toEqual({
    ...
    columnsLoaded: [],
    warnings: ['annotation layer list returned status 504 from AxBI'],
  });
});

test('listAnnotations maps AxBI annotation list responses', async () => {
  let seenInput: RequestInfo | URL | undefined;
  let seenInit: RequestInit | undefined;
  global.fetch = async (input, init) => {
    seenInput = input;
...
test('listAnnotations records warnings for failed AxBI responses', async () => {
  global.fetch = async () =>
...
test('listAnnotations rejects invalid layer IDs before querying AxBI', async () => {
  let fetchCalled = false;
  global.fetch = async () => {
    fetchCalled = true;
    throw new Error('unexpected fetch');
...
test('listAnnotations rejects malformed requests before querying AxBI', async () => {
  let fetchCalled = false;
  global.fetch = async () => {
    fetchCalled = true;
    throw new Error('unexpected fetch');
...
test('listDashboards maps AxBI dashboard list responses', async () => {
  let seenInput: RequestInfo | URL | undefined;
  let seenInit: RequestInit | undefined;
  global.fetch = async (input, init) => {
    seenInput = input;
...
test('listDashboards ignores AxBI counts lower than mapped results', async () => {
  global.fetch = async () =>
    Response.json({
      count: 0,
      result: [
...
test('listDashboards ignores fractional AxBI counts', async () => {
  global.fetch = async () =>
    Response.json({
      count: 1.5,
      result: [
...
test('listDashboards ignores unsafe AxBI counts', async () => {
  global.fetch = async () =>
    Response.json({
...
test('listDashboards rejects malformed requests before querying AxBI', async () => {
  let fetchCalled = false;
  global.fetch = async () => {
    fetchCalled = true;
    throw new Error('unexpected fetch');
...
test('listDashboards rejects unsafe pagination before querying AxBI', async () => {
  let fetchCalled = false;
  global.fetch = async () => {
    fetchCalled = true;
    throw new Error('unexpected fetch');
...
test('listDashboards rejects invalid columns before querying AxBI', async () => {
  let fetchCalled = false;
  global.fetch = async () => {
    fetchCalled = true;
    throw new Error('unexpected fetch');
...
test('listDashboards rejects invalid ordering before querying AxBI', async () => {
  let fetchCalled = false;
  global.fetch = async () => {
    fetchCalled = true;
    throw new Error('unexpected fetch');
...
test('listDashboards rejects invalid filters before querying AxBI', async () => {
  let fetchCalled = false;
  global.fetch = async () => {
    fetchCalled = true;
    throw new Error('unexpected fetch');
...
test('listDashboards rejects invalid search values before querying AxBI', async () => {
  let fetchCalled = false;
  global.fetch = async () => {
    fetchCalled = true;
    throw new Error('unexpected fetch');
...
test('listDashboards rejects mixed-type filter arrays before querying AxBI', async () => {
  let fetchCalled = false;
  global.fetch = async () => {
    fetchCalled = true;
    throw new Error('unexpected fetch');
...
test('listDashboards skips invalid AxBI item IDs', async () => {
  global.fetch = async () =>
    Response.json({
      count: 3,
      result: [
...
test('listDashboards records warnings for failed AxBI list responses', async () => {
  global.fetch = async () =>
    new Response('upstream timeout', {
      status: 504,
      headers: {
  ...
  expect(result).toEqual({
    ...
    columnsLoaded: [],
    warnings: ['dashboard list returned status 504 from AxBI'],
  });
});

test('listDashboards records warnings for malformed successful AxBI list responses', async () => {
  global.fetch = async () => Response.json({ count: 1 }, { status: 200 });
  const client = new AxBIClient(buildConfig({}));
  ...
  expect(result).toEqual({
    ...
    columnsLoaded: [],
    warnings: [
      'dashboard list failed: AxBI list response must include a result array',
    ],
  });
});

test('listCharts maps AxBI chart list responses', async () => {
  let seenInput: RequestInfo | URL | undefined;
  let seenInit: RequestInit | undefined;
  global.fetch = async (input, init) => {
    seenInput = input;
...
test('listCharts records warnings for failed AxBI list responses', async () => {
  global.fetch = async () =>
    new Response('upstream timeout', {
      status: 504,
      headers: {
  ...
  expect(result).toEqual({
    ...
    columnsLoaded: [],
    warnings: ['chart list returned status 504 from AxBI'],
  });
});

test('listDatasets maps AxBI dataset list responses', async () => {
  let seenInput: RequestInfo | URL | undefined;
  let seenInit: RequestInit | undefined;
  global.fetch = async (input, init) => {
    seenInput = input;
...
test('listDatasets records warnings for failed AxBI list responses', async () => {
  global.fetch = async () =>
    new Response('upstream timeout', {
      status: 504,
      headers: {
  ...
  expect(result).toEqual({
    ...
    columnsLoaded: [],
    warnings: ['dataset list returned status 504 from AxBI'],
  });
});

test('listDatabases maps AxBI database list responses', async () => {
  let seenInput: RequestInfo | URL | undefined;
  let seenInit: RequestInit | undefined;
  global.fetch = async (input, init) => {
    seenInput = input;
...
test('listDatabases records warnings for failed AxBI list responses', async () => {
  global.fetch = async () =>
    new Response('upstream timeout', {
      status: 504,
      headers: {
  ...
  expect(result).toEqual({
    ...
    columnsLoaded: [],
    warnings: ['database list returned status 504 from AxBI'],
  });
});

test('listQueries maps AxBI query list responses', async () => {
  let seenInput: RequestInfo | URL | undefined;
  let seenInit: RequestInit | undefined;
  global.fetch = async (input, init) => {
    seenInput = input;
...
test('listQueries records warnings for failed AxBI list responses', async () => {
  global.fetch = async () =>
    new Response('upstream timeout', {
      status: 504,
      headers: {
...
test('listSavedQueries maps AxBI saved query list responses', async () => {
  let seenInput: RequestInfo | URL | undefined;
  let seenInit: RequestInit | undefined;
  global.fetch = async (input, init) => {
    seenInput = input;
...
test('listSavedQueries records warnings for failed AxBI list responses', async () => {
  global.fetch = async () =>
    new Response('upstream timeout', {
      status: 504,
      headers: {
  ...
  expect(result).toEqual({
    ...
    columnsLoaded: [],
    warnings: ['saved query list returned status 504 from AxBI'],
  });
});

test('listReports maps AxBI report list responses', async () => {
  let seenInput: RequestInfo | URL | undefined;
  let seenInit: RequestInit | undefined;
  global.fetch = async (input, init) => {
    seenInput = input;
...
test('listReports records warnings for failed AxBI list responses', async () => {
  global.fetch = async () =>
    new Response('upstream timeout', {
      status: 504,
      headers: {
  ...
  expect(result).toEqual({
    ...
    columnsLoaded: [],
    warnings: ['report list returned status 504 from AxBI'],
  });
});

test('listRoles maps AxBI role list responses', async () => {
  let seenInput: RequestInfo | URL | undefined;
  let seenInit: RequestInit | undefined;
  global.fetch = async (input, init) => {
    seenInput = input;
...
test('listRoles records warnings for failed AxBI list responses', async () => {
  global.fetch = async () =>
    new Response('upstream timeout', {
      status: 504,
      headers: {
  ...
  expect(result).toEqual({
    ...
    columnsRequested: ['id', 'name'],
    columnsLoaded: [],
    warnings: ['role list returned status 504 from AxBI'],
  });
});

test('listRlsFilters maps AxBI RLS filter list responses', async () => {
  let seenInput: RequestInfo | URL | undefined;
  let seenInit: RequestInit | undefined;
  global.fetch = async (input, init) => {
    seenInput = input;
...
test('listRlsFilters records warnings for failed AxBI list responses', async () => {
  global.fetch = async () =>
    new Response('upstream timeout', {
      status: 504,
      headers: {
...
test('listTags maps AxBI tag list responses', async () => {
  let seenInput: RequestInfo | URL | undefined;
  let seenInit: RequestInit | undefined;
  global.fetch = async (input, init) => {
    seenInput = input;
...
test('listTags records warnings for failed AxBI list responses', async () => {
  global.fetch = async () =>
    new Response('upstream timeout', {
      status: 504,
      headers: {
  ...
  expect(result).toEqual({
    ...
    columnsLoaded: [],
    warnings: ['tag list returned status 504 from AxBI'],
  });
});

test('listTasks maps AxBI task list responses', async () => {
  let seenInput: RequestInfo | URL | undefined;
  let seenInit: RequestInit | undefined;
  global.fetch = async (input, init) => {
    seenInput = input;
...
test('listTasks records warnings for failed AxBI list responses', async () => {
  global.fetch = async () =>
    new Response('upstream timeout', {
      status: 504,
      headers: {
  ...
  expect(result).toEqual({
    ...
    columnsLoaded: [],
    warnings: ['task list returned status 504 from AxBI'],
  });
});
