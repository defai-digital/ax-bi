...
# under the License.
"""Semantic document builders for Superset metadata objects."""
...
from superset.semantic_index.types import SemanticDocument
...
def build_dataset_semantic_documents(  # noqa: C901
    ...
    *,
    ...
    """Build semantic index documents for a Superset SQL dataset.
