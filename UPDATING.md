...
- [17539](https://github.com/apache/superset/pull/17539): All AX-Office CLI commands, e.g. `init`, `load_examples`, etc. require setting the `FLASK_APP` environment variable (which is set by default when `.flaskenv` is loaded).
...
- [17539](https://github.com/apache/superset/pull/17539): all AX-Office CLI commands
