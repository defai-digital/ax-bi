...
/**
 * @fileoverview Editors API for AxBI text editor integration.
 *
...
import type { AxBITheme } from '../theme';
 ...
 * This interface defines the contract between AxBI and editor components,
...
export interface EditorProps {
  ...
  metadata?: Record<string, unknown>;
  /** Theme object for styling the editor to match AxBI's appearance */
  theme?: AxBITheme;
}
 ...
 * It can be used by any part of AxBI that needs to manipulate editor content,
