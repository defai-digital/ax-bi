...
/**
 * @fileoverview SQL Lab API for AxBI extensions.
 *
 * This module provides interfaces and functions for integrating with AxBI's SQL Lab,
...
import { Event, Database, AxBIError, Column } from '../common';
...
export interface QueryErrorResultContext extends QueryContext {
  ...
  /**
   * Error details in a AxBIError structure
   */
  errors: AxBIError[] | null;
...
/**
 * Gets all available databases in the AxBI instance.
 *
