...
/**
 * @fileoverview Extensions API for AxBI extension management.
 *
 * This module provides functions and events for managing AxBI extensions,
 ...
 * @example
 * ```typescript
 * const chartExtension = getExtension('axbi.chart-plugins');
 * if (chartExtension) {
