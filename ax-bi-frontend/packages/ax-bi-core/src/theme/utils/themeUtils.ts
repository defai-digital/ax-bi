...
const fontSizeMap: Record<FontSizeKey, keyof AxBITheme> = {
  xs: 'fontSizeXS',
  s: 'fontSizeSM',
  m: 'fontSize',
  l: 'fontSizeLG',
 ...
 */
export function getFontSize(theme: AxBITheme, size?: FontSizeKey): string {
 ...
 */
export function isThemeDark(theme: AxBITheme): boolean {
...
export function getColorVariants(
  ...
  return {
    active: theme[
      `color${firstLetterCapped}Active` as keyof AxBITheme
    ] as string,
    textActive: theme[
      `color${firstLetterCapped}TextActive` as keyof AxBITheme
    ] as string,
    text: theme[`color${firstLetterCapped}Text` as keyof AxBITheme] as string,
    textHover: theme[
      `color${firstLetterCapped}TextHover` as keyof AxBITheme
    ] as string,
    hover: theme[`color${firstLetterCapped}Hover` as keyof AxBITheme] as string,
    borderHover: theme[
      `color${firstLetterCapped}BorderHover` as keyof AxBITheme
    ] as string,
    border: theme[
      `color${firstLetterCapped}Border` as keyof AxBITheme
    ] as string,
    bgHover: theme[
      `color${firstLetterCapped}BgHover` as keyof AxBITheme
    ] as string,
    bg: theme[`color${firstLetterCapped}Bg` as keyof AxBITheme] as string,
  };
}
...
export function useThemeMode(): boolean {
  const theme = useEmotionTheme() as AxBITheme;
