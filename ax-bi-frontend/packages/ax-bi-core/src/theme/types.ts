...
export interface AxBISpecificTokens {
  ...
  // Secondary button tokens (AxBI-specific)
 ...
 * we actually allow in the AxBITheme.
 */
...
/** The final shape for our custom theme object, combining shared antd + axbi specifics. */
export type AxBITheme = SharedAntdTokens & AxBISpecificTokens;
 ...
 */
export interface AxBIThemeConfig {
