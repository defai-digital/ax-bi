...
/**
 * @fileoverview Core types and utilities for AxBI extensions.
 *
 * This module provides fundamental types and interfaces used throughout the
 * AxBI extension API. It includes database metadata types, event handling,
...
// Keep in sync with axbi/errors.py
export type ErrorLevel = 'info' | 'warning' | 'error';

/**
 * AxBI error object structure.
 * Contains details about an error that occurred within AxBI.
 */
export type AxBIError = {
  /**
   * Error types, see enum of AxBIErrorType in axbi/errors.py
   */
  error_type: string;
...
/**
 * Generic data types, see enum of the same name in axbi/utils/core.py.
 */
 ...
 * events throughout the AxBI extension system.
 *
...
/**
 * Represents a AxBI extension with its metadata.
 * Extensions are modular components that can extend AxBI's functionality
