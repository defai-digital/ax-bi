...
export default class AxBIClientClass {
  ...
  isAuthenticated(): boolean {
    // if CSRF protection is disabled in the AxBI app, the token may be an empty string
  ...
  async ensureAuth(): CsrfPromise {
    return (
      ...
      Promise.reject({
        error: `AxBIClient has not been provided a CSRF token, ensure it is
