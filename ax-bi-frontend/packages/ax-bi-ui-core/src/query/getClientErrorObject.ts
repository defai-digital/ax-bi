...
// (@ax-bi/ui-core) creates a cycle that leaves these value bindings
// undefined while the barrel evaluates
import { COMMON_ERR_MESSAGES } from '../connection/constants';
import type { JsonObject, AxBIClientResponse } from '../connection/types';
import { ErrorTypeEnum, type AxBIError } from './types/Query';
...
// the AxBIClientResponse object, and can contain a spread JSON blob
...
type ErrorType =
  AxBIClientResponse | TimeoutError | { response: Response } | string;
