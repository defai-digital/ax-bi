...
test('removes duplicated values', async () => {
  ...
  const input = getElementByClassName('input.ant-select-input');
...
// Test for checking the issue described in: https://github.com/defai-digital/ax-bi/issues/35132
...
// Reference for the bug this tests: https://github.com/defai-digital/ax-bi/pull/33043#issuecomment-2809419640
