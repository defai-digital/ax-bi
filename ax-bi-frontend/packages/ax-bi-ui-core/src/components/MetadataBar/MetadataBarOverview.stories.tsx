...
Some of the common applications in AxBI are:
...
This process is important to make sure the new type is reviewed by the design team, improving AxBI consistency.
