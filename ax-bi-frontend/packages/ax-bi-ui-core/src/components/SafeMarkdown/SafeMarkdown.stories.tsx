...
[Link to AX BI](https://github.com/defai-digital/ax-bi)
`,
...
Visit https://github.com/defai-digital/ax-bi for more info.
...
<a href="https://github.com/defai-digital/ax-bi">Safe link</a>
          `}
          htmlSanitization
        />
      </div>
...
DashboardUseCases.parameters = {
  docs: {
    description: {
      story:
        'Real-world examples of how SafeMarkdown is used in AxBI dashboards for chart descriptions, data quality notes, and metric definitions.',
    },
  },
};
