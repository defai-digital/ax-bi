...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Icon library for AX BI. Contains over 200 icons based on Ant Design icons with consistent sizing and theming support.',
      },
    },
  },
};
...
const palette: Record<string, string | null> = {
  Default: null,
  Primary: axbiTheme.colorPrimary,
  Success: axbiTheme.colorSuccess,
  Warning: axbiTheme.colorWarning,
  Error: axbiTheme.colorError,
  Info: axbiTheme.colorInfo,
  Text: axbiTheme.colorText,
  'Text Secondary': axbiTheme.colorTextSecondary,
  Icon: axbiTheme.colorIcon,
};
