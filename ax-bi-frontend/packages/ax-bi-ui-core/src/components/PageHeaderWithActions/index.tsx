...
export const menuTriggerStyles = (theme: AxBITheme) => css`
...
const headerStyles = (theme: AxBITheme) => css`
  display: flex;
  flex-direction: row;
  align-items: center;
  flex-wrap: nowrap;
...
const buttonsStyles = (theme: AxBITheme) => css`
  display: flex;
  align-items: center;
...
const additionalActionsContainerStyles = (theme: AxBITheme) => css`
