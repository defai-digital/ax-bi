 ...
 * under the License.
 */
import { Typography, Flex, Space } from '@ax-bi/ui-core/components';
...
A **themed syntax highlighter** for AxBI that supports multiple languages and automatic theme switching.
...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "A themed syntax highlighter component that automatically adapts to AxBI's light/dark themes and supports lazy loading of languages.",
      },
    },
  },
};
