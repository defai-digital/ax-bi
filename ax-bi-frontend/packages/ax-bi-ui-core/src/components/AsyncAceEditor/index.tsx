...
import {
  AsyncEsmComponent,
  PlaceholderProps,
} from '@ax-bi/ui-core/components/AsyncEsmComponent';
import { useTheme, css, type AxBITheme } from '@ax-bi/core/theme';
 ...
 */
export const aceCompletionHighlightStyles = (token: AxBITheme) => css`
