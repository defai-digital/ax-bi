...
export interface ThemedAgGridReactProps extends AgGridReactProps {
   ...
   * These will be merged with the default AxBI theme values.
   *
   * @example
   * ```tsx
   * <ThemedAgGridReact
...
/**
 * ThemedAgGridReact - A wrapper around AgGridReact that applies AxBI theming
 *
 * This component:
 * - Preserves the full AgGridReactProps interface for drop-in replacement
 * - Applies AxBI theme variables via ag-grid's JavaScript theming API
