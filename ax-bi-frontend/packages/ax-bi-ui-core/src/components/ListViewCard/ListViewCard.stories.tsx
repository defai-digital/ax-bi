...
export const InteractiveListViewCard: Story = {
  args: {
    title: 'AxBI Card Title',
    loading: false,
    url: '/ax-bi/dashboard/births/',
    imgURL: 'https://picsum.photos/seed/ax-bi/300/200',
...
export const AxBIListViewCard: Story = {
  args: {
    title: 'AxBI Card Title',
    loading: false,
    url: '/ax-bi/dashboard/births/',
    imgURL: 'https://picsum.photos/seed/axbi2/300/200',
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit...',
    coverLeft: 'Left Section',
    coverRight: 'Right Section',
  },
