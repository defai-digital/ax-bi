...
import {
  ...
  sunburstFormData,
  wordCloudFormData,
} from '../../../../ax-bi-ui-core/test/chart/fixtures/formData';
...
export const dataProvider = ({
  ...
  <div style={{ margin: 16 }}>
    <VerifyCORS host={host}>
      {() => (
        <ChartDataProvider client={AxBIClient} formData={JSON.parse(formData)}>
...
dataProvider.argTypes = {
  host: {
    control: 'text',
    description: 'Set AxBI App host for CORS request',
  },
  visType: {
    control: 'select',
    options: VIS_TYPES,
