    ...
    this.answers = await this.prompt([
      {
        ...
        // Default to current folder name, e.g. axbi-plugin-chart-hello-world
      ...
      },
      {
        ...
        // Hello World
        default: startCase(
          camelCase(this.appname.replace('axbi plugin chart', '').trim()),
        ),
      },
      {
        type: 'input',
