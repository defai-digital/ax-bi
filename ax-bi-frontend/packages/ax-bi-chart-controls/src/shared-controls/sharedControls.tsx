 ...
 */
/**
 * This file exports all controls available for use in chart plugins internal to AxBI.
...
// scope, and the @ax-bi/ui-core barrel can be mid-evaluation (import
// cycle), leaving the bindings undefined
import {
  getCategoricalSchemeRegistry,
  getSequentialSchemeRegistry,
  SequentialScheme,
} from '@ax-bi/ui-core/color';
import {
  legacyValidateInteger,
  validateMaxValue,
} from '@ax-bi/ui-core/validator';
import { ComparisonType } from '@ax-bi/ui-core/query/types/AdvancedAnalytics';
import { ensureIsArray, isDefined } from '@ax-bi/ui-core/utils';
import { NO_TIME_RANGE } from '@ax-bi/ui-core/query/constants';
import getColumnLabel from '@ax-bi/ui-core/query/getColumnLabel';
