...
// scope, and the @ax-bi/ui-core barrel can be mid-evaluation (cycle)
import { ContributionType } from '@ax-bi/ui-core/query/types/Query';
import { ensureIsArray } from '@ax-bi/ui-core/utils';
import getColumnLabel from '@ax-bi/ui-core/query/getColumnLabel';
import getMetricLabel from '@ax-bi/ui-core/query/getMetricLabel';
import type {
  QueryFormColumn,
  QueryFormMetric,
} from '@ax-bi/ui-core/query/types/QueryFormData';
...
export const xAxisSortControl = {
  ...
  config: {
    ...
    mapStateToProps: (state: ControlPanelState, controlState: ControlState) => {
      ...
      const metricLabels = Array.from(new Set(metrics.map(getMetricLabel)));
      const options = [
