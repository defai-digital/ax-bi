...
export type { Metric } from '@ax-bi/ui-core';
...
// Ref:ax-bi-frontend/src/explore/store.js
...
// Ref: ax-bi-frontend/src/explore/components/ControlPanelsContainer.jsx
...
// Ref: ax-bi-frontend/src/explore/components/controls/index.js
...
> extends AnyDict {
  ...
  label?:
    ...
    | ((
        ...
        // TODO: add strict `chartState` typing (see ax-bi-frontend/src/explore/types)
        chartState?: AnyDict,
      ) => ReactNode);
  description?:
    | ReactNode
...
// Ref: ax-bi-frontend/@ax-bi/ui-core/components/Select/AxBIStyledSelect.tsx
...
export type CustomControlConfig<P = {}> = BaseControlConfig<ComponentType<P>> &
  // two run-time properties from ax-bi-frontend/src/explore/components/Control.jsx
...
// Ref:
//  - ax-bi-frontend/src/explore/components/ControlPanelsContainer.jsx
//  - ax-bi-frontend/src/explore/components/ControlPanelSection.jsx
...
// Ref:
//  - ax-bi-frontend/src/explore/components/ConditionalFormattingControl.tsx
