...
describe('logger middleware', () => {
  ...
  test('should not log events generated by the Action Logs page', () => {
    const locationSpy = jest.spyOn(window, 'location', 'get').mockReturnValue({
      ...window.location,
      href: 'http://localhost/actionlog/list?pageIndex=0',
    } as Location);

    try {
      (logger as Function)(mockStore)(next)({
        type: LOG_EVENT,
        payload: {
          eventName: LOG_ACTIONS_SPA_NAVIGATION,
          eventData: { path: '/actionlog/list' },
        },
      });
      jest.advanceTimersByTime(2000);
