...
test('should offer the full set of page-size options', async () => {
  ...
  // its overlay on mouseDown of the select root (antd v6 replaced the
  // .ant-select-selector wrapper with .ant-select-content) rather than via
  // a click on the inner combobox input.
