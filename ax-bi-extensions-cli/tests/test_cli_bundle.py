...
from axbi_extensions_cli.cli import app, get_bundle_default_filename
from tests.utils import assert_file_exists


# Bundle Command Tests
@pytest.mark.cli
@patch("axbi_extensions_cli.cli.build")
...
def test_bundle_rejects_manifest_metadata_that_builds_nested_default_filename(
    ...
    monkeypatch.setattr(
        "axbi_extensions_cli.cli.Manifest.model_validate_json",
