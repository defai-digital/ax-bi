...
def test_email_chart_report_schedule_with_cc_bcc(
    ...
    with freeze_time("2020-01-01T00:00:00Z"):
        ...
        assert (
            '<a href="http://127.0.0.1:8080/explore/?form_data=%7B%22slice_id%22:+'
...
|  1 | c21  | c22  | c23       |"""
        ...
        assert (
            f"<http://127.0.0.1:8080/explore/?form_data=%7B%22slice_id%22:+{create_report_slack_chart_with_text.chart.id}%7D&force=false|Explore in AxBI>"  # noqa: E501
            in slack_client_mock_class.return_value.chat_postMessage.call_args[1][
                "text"
            ]
        )
...
def test_email_dashboard_report_fails_uncaught_exception(
    ...
    assert (
        '<a href="http://127.0.0.1:8080/ax-bi/dashboard/'
