...
def test_get_iam_credentials_access_denied() -> None:
    ...
    from axbi.db_engine_specs.aws_iam import (
        _credentials_cache,
        _credentials_lock,
        AWSIAMAuthMixin,
    )
...
def test_apply_iam_authentication() -> None:
    ...
    assert token_call_kwargs["username"] == "axbi_iam_user"
