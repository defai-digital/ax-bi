...
# PR Highlights
Below is a highlight of the PRs included in this update. The full release history can be found in [GitHub Releases](https://github.com/apache/superset/releases).
...
To see the complete release history, see [apache/superset releases](https://github.com/apache/superset/releases).
