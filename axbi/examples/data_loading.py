...
from axbi.cli.test_loaders import load_big_data
...
def discover_datasets() -> dict[str, Callable[..., None]]:
    ...
    Examples are organized as:
        axbi/examples/{example_name}/data.parquet           # Single dataset
        axbi/examples/{example_name}/data/{name}.parquet    # Multiple datasets
