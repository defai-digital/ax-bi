...
from axbi.extensions import celery_app, db
...
from axbi.utils.core import LoggerLevel
...
def execute_task(  # noqa: C901
    ...
    """
    from axbi.commands.tasks.internal_update import InternalStatusTransitionCommand
