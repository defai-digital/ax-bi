...
from axbi_core.tasks.types import (
...
if TYPE_CHECKING:
    ...
    from axbi.tasks.manager import AbortListener
...
class TaskContext(CoreTaskContext):
    ...
    def _write_to_db(self) -> None:
        ...
        """
        from axbi.commands.tasks.internal_update import InternalUpdateTaskCommand
