...
from axbi_core.tasks.types import TaskOptions, TaskScope, TaskStatus
...
from axbi.tasks.utils import generate_random_task_key
...
def task(
    ...
    *,
    ...
    Args:
        ...
        name: Optional unique task name (e.g., "axbi.generate_thumbnail").
