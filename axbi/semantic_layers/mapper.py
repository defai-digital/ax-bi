...
from axbi.common.utils.time_range_utils import get_since_until_from_query_object
...
from axbi.result_set import stringify_extension_columns
from axbi.utils.core import (
    FilterOperator,
    QueryObjectFilterClause,
    TIME_COMPARISON,
)
from axbi.utils.date_parser import get_past_or_future
...
def get_results(query_object: QueryObject) -> QueryResult:
    ...
    :return: QueryResult compatible with AxBI's query interface
    """
