...
def _sl(legacy: str, semantic: str) -> str:
    ...
    # (axbi.semantic_layers.labels is imported by axbi.initialization,
    # which is itself imported during axbi package initialization).
    from axbi import feature_flag_manager  # pylint: disable=import-outside-toplevel
