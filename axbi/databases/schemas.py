...
from axbi.databases.types import (  # pylint:disable=unused-import
...
from axbi.exceptions import AxBISecurityException, CertificateException
from axbi.models.core import ConfigurationMethod, Database
from axbi.security.analytics_db_safety import check_sqlalchemy_uri
from axbi.utils import json
from axbi.utils.core import markdown, parse_ssl_cert
from axbi.utils.json import get_masked_fields
...
def rename_encrypted_extra(
    ...
    **kwargs: Any,
    ...
    AxBI backwards compatible with older clients.
    """
    if not isinstance(data, dict):
        return data
...
class ImportV1DatabaseExtraSchema(Schema):
    ...
    def fix_schemas_allowed_for_csv_upload(  # pylint: disable=invalid-name
        ...
        # Fix for https://github.com/defai-digital/ax-bi/pull/16756, which temporarily
