...
from axbi import db, event_logger, is_feature_enabled
from axbi.axbi_typing import FlaskResponse
from axbi.commands.database.create import CreateDatabaseCommand
from axbi.commands.database.delete import DeleteDatabaseCommand
...
from axbi.commands.database.importers.dispatcher import ImportDatabasesCommand
...
from axbi.commands.database.uploaders.local_db import get_or_create_local_db
from axbi.commands.database.uploaders.structured_reader import (
    StructuredReader,
...
from axbi.commands.importers.exceptions import (
...
from axbi.databases.decorators import check_table_access
from axbi.databases.filters import DatabaseFilter, DatabaseUploadEnabledFilter
from axbi.databases.schemas import (
...
from axbi.databases.utils import get_table_metadata
...
from axbi.utils.ssh_tunnel import mask_password_info
...
from axbi.views.error_handling import handle_api_exception, json_error_response
...
class DatabaseRestApi(BaseAxBIModelRestApi):
    ...
    def post(self) -> FlaskResponse:  # noqa: C901
        ...
        except AxBIErrorsException as ex:
    ...
    def oauth2(self) -> FlaskResponse:
        ...
        return make_response(
            render_template("axbi/oauth2.html", tab_id=tab_id),
            200,
        )
