...
from axbi import db
from axbi.key_value.exceptions import KeyValueCreateFailedError
...
class AxBIMetastoreCache(BaseCache):
    def __init__(
        self,
        namespace: UUID,
        codec: KeyValueCodec,
    ...
    def factory(
        ...
        if (
            ...
            logger.warning(
                "Using PickleKeyValueCodec with AxBIMetastoreCache may be unsafe, "
