...
from axbi.utils.class_utils import load_class_from_name
...
class SSHManager:
    ...
    def create_tunnel(
        ...
        # axbi.utils.ssh_tunnel -> axbi.databases.ssh_tunnel.models
        # -> axbi.extensions -> axbi.extensions.ssh (this module).
        from axbi.utils.ssh_tunnel import get_default_port
