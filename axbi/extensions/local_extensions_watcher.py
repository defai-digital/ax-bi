    ...
    try:
        ...
        class LocalExtensionFileHandler(FileSystemEventHandler):
            ...
            def on_any_event(self, event: Any) -> None:
                ...
                # Touch axbi/__init__.py to trigger Flask's file watcher
                axbi_init = Path("axbi/__init__.py")
                logger.info("Triggering restart by touching %s", axbi_init)
                os.utime(axbi_init, (time.time(), time.time()))
