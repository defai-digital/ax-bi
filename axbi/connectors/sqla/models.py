...
from axbi_core.common.models import Dataset as CoreDataset
...
from axbi.db_engine_specs.base import BaseEngineSpec, TimestampExpression
...
from axbi.explorables.base import TimeGrainDict
...
from axbi.sql.parse import sanitize_clause, SQLStatement, Table
...
class BaseDatasource(
    ...
    def query(self, query_obj: QueryObjectDict) -> QueryResult:
        ...
        query_obj is a dictionary representing AxBI's query interface.
        Should return a ``axbi.models.helpers.QueryResult``
        """
        raise NotImplementedError()
    ...
    def get_sqla_row_level_filters(
        ...
        try:
            ...
            if is_feature_enabled("EMBEDDED_AXBI"):
        ...
        if col_in_metadata := self.get_column(metadata_lookup_key.strip()):
            ...
            if has_timegrain or force_type_check:
                try:
                    ...
                    if not col_desc:
                        raise AxBIGenericDBErrorException("Column not found")
                ...
                except AxBIGenericDBErrorException as ex:
