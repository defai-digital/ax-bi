...
from axbi.utils.slack import get_user_avatar, SlackClientError
from axbi.views.base_api import BaseAxBIApi, requires_json, statsd_metrics
from axbi.views.users.schemas import CurrentUserPutSchema, UserResponseSchema
from axbi.views.utils import bootstrap_user_data

user_response_schema = UserResponseSchema()


class CurrentUserRestApi(BaseAxBIApi):
