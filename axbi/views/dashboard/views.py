...
from axbi.constants import MODEL_VIEW_RW_METHOD_PERMISSION_MAP, RouteMethod
from axbi.models.dashboard import Dashboard as DashboardModel
...
from axbi.views.dashboard.mixin import DashboardMixin


class DashboardModelView(DashboardMixin, AxBIModelView, DeleteMixin):  # pylint: disable=too-many-ancestors
...
class Dashboard(BaseAxBIView):
    ...
    def new(self) -> FlaskResponse:
        ...
        return redirect(
            url_for(
                "AxBI.dashboard", dashboard_id_or_slug=new_dashboard.id, edit="true"
            )
        )
