...
from axbi.exceptions import InvalidPayloadFormatError
from axbi.extensions import db, event_logger, security_manager, stats_logger_manager
from axbi.models.core import FavStar
from axbi.models.dashboard import Dashboard
from axbi.models.slice import Slice
from axbi.schemas import error_payload_content
from axbi.sql_lab import Query as SqllabQuery
from axbi.utils import json
from axbi.utils.core import get_user_id, time_function
...
def requires_json(f: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def wraps(self: BaseAxBIModelRestApi, *args: Any, **kwargs: Any) -> Response:
...
def requires_form_data(f: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def wraps(self: BaseAxBIApiMixin, *args: Any, **kwargs: Any) -> Response:
...
def validate_feature_flags(
    ...
    def decorate(f: Callable[..., Response]) -> Callable[..., Response]:
        @functools.wraps(f)
        def wrapper(self: BaseAxBIModelRestApi, *args: Any, **kwargs: Any) -> Response:
...
class BaseAxBIApi(BaseAxBIApiMixin, BaseApi):
    pass


class BaseAxBIModelRestApi(BaseAxBIApiMixin, ModelRestApi):
    """
    Extends FAB's ModelResApi to implement specific axbi generic functionality
    """
    ...
    def _handle_filters_args(self, rison_args: dict[str, Any]) -> Filters:
        ...
        Applies to every subclass of ``BaseAxBIModelRestApi``
