...
import axbi.models.core as models
from axbi import event_logger, security_manager
...
class LogRestApi(LogMixin, BaseAxBIModelRestApi):
    ...
    @staticmethod
    def is_enabled() -> bool:
        return app.config["FAB_ADD_SECURITY_VIEWS"] and app.config["AXBI_LOG_VIEW"]
