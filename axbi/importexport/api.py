...
from axbi.utils.core import parse_boolean_string
...
class ImportExportRestApi(BaseAxBIApi):
    """
    ...
    def export(self) -> Response:
        ...
        get:
          ...
          description: >-
            Gets a ZIP file with all the AxBI assets (databases, datasets, charts,
