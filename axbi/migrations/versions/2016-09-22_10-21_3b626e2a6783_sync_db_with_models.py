...
from axbi import db
from axbi.utils.core import generic_find_constraint_name
...
def upgrade():
    # cleanup after: https://github.com/airbnb/ax-bi/pull/1078
    try:
    ...
    # fixed issue: https://github.com/airbnb/ax-bi/issues/466
    try:
