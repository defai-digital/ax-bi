...
class ElasticSearchEngineSpec(BaseEngineSpec):  # pylint: disable=abstract-method
    ...
    def get_dbapi_exception_mapping(cls) -> dict[type[Exception], type[Exception]]:
        ...
        return {
            es_exceptions.DatabaseError: AxBIDBAPIDatabaseError,
            es_exceptions.OperationalError: AxBIDBAPIOperationalError,
            es_exceptions.ProgrammingError: AxBIDBAPIProgrammingError,
        }
