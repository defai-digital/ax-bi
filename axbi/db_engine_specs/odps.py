...
from axbi.databases.utils import (
    get_col_type,
...
from axbi.sql.parse import Partition, SQLScript, Table
...
class OdpsEngineSpec(BasicParametersMixin, OdpsBaseEngineSpec):
    ...
    metadata = {
        "description": (
            "Alibaba Cloud MaxCompute, formerly ODPS, is a managed large-scale "
            "data warehousing and batch analytics platform."
        ),
        "logo": "odps.png",
