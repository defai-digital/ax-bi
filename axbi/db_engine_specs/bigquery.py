...
from axbi.databases.schemas import encrypted_field_properties, EncryptedString
...
class BigQueryEngineSpec(BaseEngineSpec):  # pylint: disable=too-many-public-methods
    ...
    custom_errors: dict[Pattern[str], tuple[str, AxBIErrorType, dict[str, Any]]] = {
        CONNECTION_DATABASE_PERMISSIONS_REGEX: (
            ...
            AxBIErrorType.CONNECTION_DATABASE_PERMISSIONS_ERROR,
            {},
        ),
    ...
    def df_to_sql(
        ...
        if not table.schema:
            raise AxBIException("The table schema must be defined")
    ...
    def _get_client(
        ...
        try:
            ...
            raise AxBIDBAPIConnectionError(
    ...
    def estimate_query_cost(  # pylint: disable=too-many-arguments
        ...
        if not cls.get_allow_cost_estimate(extra):
            raise AxBIException("Database does not support cost estimation")
    ...
    def get_catalog_names(
        ...
        with database.get_sqla_engine() as engine:
            try:
                client = cls._get_client(engine, database)
            except AxBIDBAPIConnectionError:
                logger.warning(
    ...
    def get_dbapi_exception_mapping(cls) -> dict[type[Exception], type[Exception]]:
        ...
        return {DefaultCredentialsError: AxBIDBAPIConnectionError}
