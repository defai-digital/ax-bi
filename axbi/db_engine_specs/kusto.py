...
class KustoSqlEngineSpec(BaseEngineSpec):  # pylint: disable=abstract-method
    ...
    def get_dbapi_exception_mapping(cls) -> dict[type[Exception], type[Exception]]:
        ...
        return {
            kusto_exceptions.DatabaseError: AxBIDBAPIDatabaseError,
            kusto_exceptions.OperationalError: AxBIDBAPIOperationalError,
            kusto_exceptions.ProgrammingError: AxBIDBAPIProgrammingError,
        }
