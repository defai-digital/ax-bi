...
from axbi.utils.oauth2 import get_oauth2_access_token
...
class GSheetsEngineSpec(ShillelaghEngineSpec):
    ...
    metadata = {
        ...
        "install_instructions": 'pip install "ax-bi[gsheets]"',
    ...
    def get_oauth2_authorization_uri(
        ...
        from axbi.utils.oauth2 import encode_oauth2_state, generate_code_challenge
    ...
    def _do_post(
        ...
        **kwargs: Any,
        ...
        if not isinstance(payload, dict):
            raise AxBIException("Google Sheets API returned an unexpected response")
    ...
    def df_to_sql(  # pylint: disable=too-many-locals
        ...
        if spreadsheet_url and "if_exists" in to_sql_kwargs:
            if to_sql_kwargs["if_exists"] == "append":
                ...
                # never going to work
                raise AxBIException("Append operation not currently supported")
            if to_sql_kwargs["if_exists"] == "fail":
                raise AxBIException("Table already exists")
