...
from axbi.sql.parse import process_jinja_sql
from axbi.utils import core as utils, json
from axbi.utils.core import GenericDataType, QuerySource

if TYPE_CHECKING:
    from axbi.models.core import Database  # pragma: no cover
...
class PostgresBaseEngineSpec(BaseEngineSpec):
    ...
    custom_errors: dict[Pattern[str], tuple[str, AxBIErrorType, dict[str, Any]]] = {
        ...
        CONNECTION_INVALID_PASSWORD_NEEDED_REGEX: (
            ...
            AxBIErrorType.CONNECTION_ACCESS_DENIED_ERROR,
            {"invalid": ["password"]},
        ),
        ...
        CONNECTION_PORT_CLOSED_REGEX: (
            ...
            AxBIErrorType.CONNECTION_PORT_CLOSED_ERROR,
            {"invalid": ["host", "port"]},
        ),
        CONNECTION_HOST_DOWN_REGEX: (
            ...
            AxBIErrorType.CONNECTION_HOST_DOWN_ERROR,
            {"invalid": ["host", "port"]},
        ),
...
class PostgresEngineSpec(BasicParametersMixin, PostgresBaseEngineSpec):
    ...
    metadata = {
        ...
        "notes": "The psycopg2 library comes bundled with AxBI Docker images.",
        "connection_examples": [
            {
        ...
        "compatible_databases": [
            ...
            },
            {
                ...
                "notes": "psycopg2 comes bundled with AxBI Docker images.",
    ...
    def get_schema_from_engine_params(
        ...
        in AxBI because it breaks schema-level permissions, since it's impossible
...
WHERE datistemplate = false;
    ...
    def get_extra_params(
        ...
        :raises AxBIException: If database extra json payload is unparseable
        """
        try:
            extra = json.loads(database.extra or "{}")
        except json.JSONDecodeError as ex:
            raise AxBIException("Unable to parse database extras") from ex
