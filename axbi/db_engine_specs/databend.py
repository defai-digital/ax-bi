...
class DatabendEngineSpec(DatabendBaseEngineSpec):
    ...
    def get_dbapi_mapped_exception(cls, exception: Exception) -> Exception:
        ...
        if new_exception == AxBIDBAPIDatabaseError:
            return AxBIDBAPIDatabaseError("Connection failed")
...
class DatabendConnectEngineSpec(BasicParametersMixin, DatabendEngineSpec):
    ...
    # the native connection UI experience in AxBI.
    ...
    def validate_parameters(cls, properties: BasicPropertiesType) -> list[AxBIError]:
        # The newest versions of axbi send a "properties" object with a
