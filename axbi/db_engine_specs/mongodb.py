...
class MongoDBEngineSpec(BaseEngineSpec):
    ...
    metadata = {
        ...
        "connection_string": (
            "mongodb://{username}:{password}@{host}:{port}/{database}?mode=axbi"
        ),
        "parameters": {
        ...
        "drivers": [
            {
                ...
                "connection_string": "mongodb+srv://{username}:{password}@{host}/{database}?mode=axbi",
            ...
            },
            {
                ...
                "pypi_package": "pymongosql",
                "connection_string": "mongodb://{username}:{password}@{host}:{port}/{database}?mode=axbi",
                "is_recommended": False,
                "notes": ("For self-hosted MongoDB instances."),
            },
        ],
        "notes": "Uses PartiQL for SQL queries. Requires mode=axbi parameter.",
