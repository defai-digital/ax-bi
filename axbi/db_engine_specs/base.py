...
from axbi.constants import QUERY_CANCEL_KEY, TimeGrain as TimeGrainConstants
from axbi.databases.utils import get_table_metadata, make_url_safe
...
from axbi.utils.core import ColumnSpec, GenericDataType, QuerySource
from axbi.utils.hashing import hash_from_str
from axbi.utils.json import redact_sensitive, reveal_sensitive
from axbi.utils.network import is_hostname_valid, is_port_open
...
if TYPE_CHECKING:
    ...
    from axbi.databases.schemas import TableMetadataResponse
...
class BaseEngineSpec:  # pylint: disable=too-many-public-methods
    ...
    def start_oauth2_dance(cls, database: Database) -> None:
        ...
        can authorize AxBI to access the database. Once the user has authorized, the
        ...
        # The state is passed to the OAuth2 provider, and sent back to AxBI after
        # the user authorizes the access. The redirect endpoint in AxBI can then
    ...
    def get_allows_alias_in_select(
        ...
        In Dremio this atribute is version-dependent, so AxBI needs to inspect the
    ...
    def get_dbapi_mapped_exception(cls, exception: Exception) -> Exception:
        """
        Get a axbi custom DBAPI exception from the driver specific exception.
        ...
        :return: AxBI custom DBAPI exception
        """
    ...
    ) -> dict[Any, tuple[str, AxBIErrorType, dict[str, Any]]]:
    ...
    def adjust_engine_params(  # pylint: disable=unused-argument
        ...
        AxBI knows in which schema a given query is running in order to enforce
    ...
    def get_column_types(
        ...
        :return: SQLAlchemy and generic AxBI column types
        """
        if not column_type:
            return None
...
class BasicParametersMixin:
    ...
    @classmethod
    def validate_parameters(cls, properties: BasicPropertiesType) -> list[AxBIError]:
        """
