...
from axbi import cache_manager, db
...
from axbi.db_engine_specs.presto import PrestoBaseEngineSpec
...
class TrinoEngineSpec(PrestoBaseEngineSpec):
    ...
    metadata = {
        ...
        "pypi_packages": ["trino"],
        "install_instructions": 'pip install "ax-bi[trino]"',
    ...
    def cancel_query(cls, cursor: Cursor, query: Query, cancel_query_id: str) -> bool:
        ...
        try:
            cursor.execute(
                ...
                "message => 'Query cancelled by AxBI')"
            )
    ...
    def get_dbapi_exception_mapping(cls) -> dict[type[Exception], type[Exception]]:
        ...
        static_mapping: dict[type[Exception], type[Exception]] = {
            requests_exceptions.ConnectionError: AxBIDBAPIConnectionError,
        }
