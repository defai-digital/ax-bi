...
from axbi.db_engine_specs.base import BaseEngineSpec, DatabaseCategory, LimitMethod
from axbi.errors import AxBIError, AxBIErrorType, ErrorLevel
from axbi.utils.core import GenericDataType, get_user_agent, QuerySource
...
DEFAULT_ACCESS_TOKEN_URL = (
    "https://app.motherduck.com/token-request?appName=AxBI&close=y"  # noqa: S105
)
...
class DuckDBParametersMixin:
    ...
    @classmethod
    def validate_parameters(cls, properties: DuckDBPropertiesType) -> list[AxBIError]:
        """
