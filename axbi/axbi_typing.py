...
if TYPE_CHECKING:
    from axbi.utils.core import GenericDataType, QueryObjectFilterClause
...
class ResultSetColumnType(TypedDict):
    """
    AxBI virtual dataset column interface
    """
...
class QueryObjectDict(TypedDict, total=False):
    """
    TypedDict representation of query objects used throughout AxBI.

    This represents the dictionary output from QueryObject.to_dict() and is used
    in datasource query methods throughout AxBI.
