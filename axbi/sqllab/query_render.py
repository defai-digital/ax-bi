...
from axbi.commands.sql_lab.execute import SqlQueryRender
from axbi.errors import AxBIErrorType
from axbi.sqllab.exceptions import SqlLabException
...
class SqlQueryRenderImpl(SqlQueryRender):
    ...
    def render(self, execution_context: SqlJsonExecutionContext) -> str:
        ...
        try:
            ...
            from axbi.jinja_context import UndefinedTemplateFunctionException
    ...
    def _raise_undefined_parameter_exception(
        ...
        raise SqlQueryRenderException(
            ...
            error_type=AxBIErrorType.MISSING_TEMPLATE_PARAMS_ERROR,
    ...
    def _raise_template_exception(
        ...
        raise SqlQueryRenderException(
            sql_json_execution_context=execution_context,
            error_type=AxBIErrorType.INVALID_TEMPLATE_PARAMS_ERROR,
            reason_message=__(
