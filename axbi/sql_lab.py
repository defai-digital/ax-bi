...
from axbi.exceptions import (
    ...
    AxBIDMLNotAllowedException,
    AxBIErrorException,
    AxBIErrorsException,
    AxBIInvalidCTASException,
    AxBIInvalidCVASException,
    AxBIResultsBackendNotConfigureException,
    OAuth2RedirectError,
)
from axbi.extensions import celery_app, event_logger
from axbi.models.sql_lab import Query
from axbi.result_set import AxBIResultSet
from axbi.sql.parse import BaseSQLStatement, CTASMethod, SQLScript, Table
...
def execute_query(  # pylint: disable=too-many-statements, too-many-locals  # noqa: C901
    ...
    return AxBIResultSet(data, cursor_description, db_engine_spec)
...
def execute_sql_statements(  # noqa: C901
    ...
    if database.allow_run_async and not results_backend:
        raise AxBIResultsBackendNotConfigureException()
    ...
    if parsed_script.has_mutation() and not database.allow_dml:
        raise AxBIDMLNotAllowedException()
