...
from axbi.commands.database.utils import ping
...
from axbi.utils.ssh_tunnel import get_default_port, unmask_password_info
...
class TestConnectionDatabaseCommand(BaseCommand):
    ...
    def run(  # noqa: C901
        ...
        try:
            ...
            raise AxBIErrorsException(errors, status=400) from ex
