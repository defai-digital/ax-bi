...
from axbi.utils.core import check_is_safe_zip
        ...
        if schema:
            ...
            try:
                ...
                if prefix == "datasets" and "data" in config:
                    from axbi.examples.helpers import normalize_example_data_url
                ...
                logger.error(
                    "Schema validation failed for %s (prefix: %s)",
                    file_name,
                    prefix,
                )
