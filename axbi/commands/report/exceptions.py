...
from axbi.exceptions import AxBIError, AxBIErrorsException
...
class ReportScheduleSystemErrorsException(CommandException, AxBIErrorsException):
    errors: list[AxBIError] = []
    message = _("Report schedule system error")


class ReportScheduleClientErrorsException(CommandException, AxBIErrorsException):
    status = 400
    errors: list[AxBIError] = []
