...
from axbi.models.core import Database, FavStar, Log
...
class ResetAxBICommand(BaseCommand):
    def __init__(
        self,
        confirm: bool,
        user: Any,
    ...
    def run(self) -> None:
        self.validate()
        logger.debug("Resetting AxBI Started")
        ...
        logger.debug("Resetting AxBI Completed")
