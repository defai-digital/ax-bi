...
if TYPE_CHECKING:
    ...
    from axbi.sqllab.sql_json_executer import SqlJsonExecutor
...
class ExecuteSqlCommand(BaseCommand):
    ...
    def run(
        ...
        except (AxBIErrorException, AxBIErrorsException):
            # to make sure we raising the original
            # AxBIErrorsException || AxBIErrorsException
            raise
