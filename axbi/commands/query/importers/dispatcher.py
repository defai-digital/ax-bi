...
from axbi.commands.query.importers import v1
...
class ImportSavedQueriesCommand(ImportersCommand):
    """
    ...
    log_validation_error_as_exception = True
    log_unexpected_errors = False
