...
This tool generates a URL to the AxBI explore interface with the specified
chart configuration.
"""
...
from axbi.mcp_service.explore.schemas import GenerateExploreLinkResponse
...
async def generate_explore_link(
    ...
    try:
        ...
        # the dataset in AxBI without a preconfigured chart.
