...
# be silently misidentified as a AxBI API-key request.
API_KEY_PASSTHROUGH_CLAIM = "_axbi_mcp_api_key_passthrough"
...
API_KEY_VALIDATED_USERNAME_CLAIM = "_axbi_mcp_validated_username"
