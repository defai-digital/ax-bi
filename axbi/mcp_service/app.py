...
- Parameter name reminders: ALWAYS use the EXACT parameter names from the tool schema.
  Do NOT use AxBI's internal form_data names.
...
# Replaces the stub @tool/@prompt decorators in axbi_core.mcp.decorators
# with concrete implementations bound to this mcp instance.
from axbi.core.mcp.core_mcp_injection import (  # noqa: E402
...
# Tools use the @tool decorator from `ax-bi-core` and register automatically
...
from axbi.mcp_service.ai.tool import (  # noqa: F401, E402
...
from axbi.mcp_service.annotation_layer.tool import (  # noqa: F401, E402
    get_annotation_layer_info,
    get_layer_annotation_info,
    list_annotation_layers,
    list_layer_annotations,
)
from axbi.mcp_service.chart import (  # noqa: F401, E402
    prompts as chart_prompts,
    resources as chart_resources,
)
from axbi.mcp_service.chart.tool import (  # noqa: F401, E402
    generate_chart,
    get_chart_data,
    get_chart_info,
    get_chart_preview,
...
from axbi.mcp_service.dashboard.tool import (  # noqa: F401, E402
    add_chart_to_existing_dashboard,
...
from axbi.mcp_service.database.tool import (  # noqa: F401, E402
    get_database_info,
    list_databases,
)
from axbi.mcp_service.dataset.tool import (  # noqa: F401, E402
    create_dataset,
...
from axbi.mcp_service.explore.tool import (  # noqa: F401, E402
    generate_explore_link,
)
from axbi.mcp_service.query.tool import (  # noqa: F401, E402
    get_query_info,
    list_queries,
)
from axbi.mcp_service.report.tool import (  # noqa: F401, E402
    create_report,
    get_report_info,
    list_reports,
)
from axbi.mcp_service.rls.tool import (  # noqa: F401, E402
    get_rls_filter_info,
    list_rls_filters,
)
from axbi.mcp_service.role.tool import (  # noqa: F401, E402
    get_role_info,
    list_roles,
)
from axbi.mcp_service.saved_query.tool import (  # noqa: F401, E402
    get_saved_query_info,
    list_saved_queries,
)
from axbi.mcp_service.sql_lab.tool import (  # noqa: F401, E402
    execute_sql,
    open_sql_lab_with_context,
    save_sql_query,
)
from axbi.mcp_service.system import (  # noqa: F401, E402
    prompts as system_prompts,
    resources as system_resources,
)
from axbi.mcp_service.system.tool import (  # noqa: F401, E402
    find_users,
    generate_bug_report,
    get_instance_info,
    get_schema,
...
from axbi.mcp_service.tag.tool import (  # noqa: F401, E402
    get_tag_info,
    list_tags,
)
from axbi.mcp_service.task.tool import (  # noqa: F401, E402
    get_task_info,
    list_tasks,
)
from axbi.mcp_service.user.tool import (  # noqa: F401, E402
    get_user_info,
    list_users,
)
...
def _remove_disabled_tools(disabled_tools: set[str]) -> None:
    ...
    this via MCP_DISABLED_TOOLS in axbi_config.py.
    """
...
def _apply_config_guards(flask_app: Any) -> set[str]:
    ...
    - Task tools: mirrors TaskRestApi conditional registration which checks
      ...
      all AxBI enablement paths (DEFAULT_FEATURE_FLAGS, GET_FEATURE_FLAGS_FUNC,
      IS_FEATURE_ENABLED_FUNC, etc.) are respected.
    """
    removed: set[str] = set()

    from axbi.extensions import feature_flag_manager  # noqa: PLC0415
...
def init_fastmcp_server(
    ...
    **kwargs: Any,
    ...
    """
    # circular import: flask_singleton imports from axbi.extensions which
    # re-enters mcp_service during startup; must stay lazy inside the function.
    from axbi.mcp_service.flask_singleton import app as flask_app  # noqa: PLC0415

    # Derive branding from AX BI's APP_NAME config.
    app_name = get_axbi_app_name(flask_app.config)
    branding = app_name
