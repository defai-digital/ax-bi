...
class GetDatasetInfoRequest(MetadataCacheControl):
    ...
    def _parse_column_fields(cls, value: Any) -> Any:
        from axbi.mcp_service.utils.schema_utils import parse_json_or_list
...
class CreateVirtualDatasetResponse(SanitizeOptionalErrorMixin):
    ...
    url: str | None = Field(
        None,
        description="URL to view/edit the dataset in AxBI. None if failed.",
    )
