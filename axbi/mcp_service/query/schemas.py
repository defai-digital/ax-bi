...
from axbi.mcp_service.utils.response_utils import filter_serialized_response_fields
...
class QueryInfo(BaseModel):
    ...
    schema_name: str | None = Field(
        None, description="Database schema name", alias="schema"
    )
...
class ListQueriesRequest(BaseModel):
    ...
    def parse_filters(cls, v: Any) -> list[QueryFilter]:
        ...
        return parse_filters(v, QueryFilter)
...
class QueryError(MCPResourceError):
    pass
