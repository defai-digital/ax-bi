...
This module provides utilities for working with AxBI's cache layers
...
from axbi.mcp_service.common.cache_schemas import CacheStatus
...
def get_cache_status_from_result(
    ...
    """
    Extract cache status information from a AxBI query result.

    Args:
        result: Query result dictionary from AxBI
