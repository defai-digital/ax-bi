...
"""
WebDriver pool configuration defaults for AX BI MCP service
"""
...
def configure_webdriver_pool(app_config: dict[str, Any]) -> None:
    """
    Configure WebDriver pool settings in AxBI app config.

    This function adds WebDriver pool configuration to the AxBI app config
    if it doesn't already exist, using sensible defaults.

    Args:
        app_config: The AxBI application configuration dictionary
    """
