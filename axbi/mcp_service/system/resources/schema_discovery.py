...
from axbi.mcp_service.common.schema_discovery import build_schema_resource

logger = logging.getLogger(__name__)


@mcp.resource("axbi://schema/chart")
@mcp_auth_hook
...
@mcp.resource("axbi://schema/dataset")
@mcp_auth_hook
...
@mcp.resource("axbi://schema/dashboard")
@mcp_auth_hook
...
def get_all_schemas_resource() -> str:
    ...
    all_schemas = {
        ...
        "metadata": {
            "description": "Schema discovery metadata for AX BI MCP service",
            "usage": {
