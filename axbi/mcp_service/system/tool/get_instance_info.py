...
from axbi.mcp_service.system.schemas import (
    GetAxBIInstanceInfoRequest,
    InstanceInfo,
    serialize_user_object,
)
from axbi.mcp_service.system.system_utils import (
...
_DEFAULT_INSTANCE_INFO_REQUEST = GetAxBIInstanceInfoRequest()
...
def get_instance_info(
    request: GetAxBIInstanceInfoRequest = _DEFAULT_INSTANCE_INFO_REQUEST,
    ctx: Context = None,
) -> InstanceInfo:
