...
def _create_dashboard_layout(chart_objects: list[Any]) -> dict[str, Any]:
    ...
    matching the component structure that the AxBI frontend expects.
    ...
    # Grid configuration based on real AxBI dashboard patterns
...
def generate_dashboard(  # noqa: C901
    ...
    try:
        ...
        dashboard_info = DashboardInfo(
            ...
            url=f"{get_axbi_base_url()}/ax-bi/dashboard/{dashboard.id}/",
            chart_count=len(request.chart_ids),
            tags=[
