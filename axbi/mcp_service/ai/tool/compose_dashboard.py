...
def _build_native_filters(  # noqa: C901
    global_filters: list[dict[str, Any]],
    plan_datasets: list[dict[str, Any]] | None = None,
) -> list[dict[str, Any]]:
    """Convert plan global_filters into AxBI native filter configuration.
    ...
    for gf in global_filters:
        ...
        filter_config: dict[str, Any] = {
            "id": filter_id,
            "name": gf.get("name") or (str(column) if column else "Filter"),
