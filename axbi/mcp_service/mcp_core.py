...
from axbi.mcp_service.constants import MAX_PAGE_SIZE, ModelType
...
from axbi.mcp_service.utils.permissions_utils import get_current_user
...
class ModelGetInfoCore(BaseCore):
    ...
    def _find_object(self, identifier: int | str) -> Any:
        ...
        if self.supports_slug:
            ...
            from axbi.models.dashboard import id_or_slug_filter
...
class InstanceInfoCore(BaseCore):
    ...
    Provides a flexible way to gather and present statistics about a AxBI
