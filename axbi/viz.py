...
from axbi.utils import core as utils, csv, json
from axbi.utils.cache import set_and_log_cache
...
from axbi.utils.date_parser import get_since_until, parse_past_timedelta
...
class TimeTableViz(BaseViz):
    ...
    credits = 'an <a href="https://github.com/defai-digital/ax-bi">AX BI</a> original'
    is_timeseries = True
...
class WorldMapViz(BaseViz):
    ...
    def get_data(self, df: pd.DataFrame) -> VizData:
        ...
        from axbi.examples import countries
