...
class NotificationError(AxBIException):
    """
...
class SlackV1NotificationError(AxBIException):
    """
...
class NotificationParamException(AxBIException):
    status = 422


class NotificationAuthorizationException(AxBIException):
    status = 401


class NotificationUnprocessableException(AxBIException):
    """
...
class NotificationMalformedException(AxBIException):
    status = 400
