...
from axbi.charts.filters import ChartFilter
from axbi.commands.report.create import CreateReportScheduleCommand
from axbi.commands.report.delete import DeleteReportScheduleCommand
...
from axbi.dashboards.filters import DashboardAccessFilter
...
from axbi.reports.filters import ReportScheduleAllTextFilter, ReportScheduleFilter
from axbi.reports.models import ReportCreationMethod, ReportSchedule
...
from axbi.utils.slack import get_channels_with_search
...
class ReportScheduleRestApi(BaseAxBIModelRestApi):
    ...
    extra_fields_rel_fields = {
        **BaseAxBIModelRestApi.extra_fields_rel_fields,
