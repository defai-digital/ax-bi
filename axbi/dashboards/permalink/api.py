...
from axbi.dashboards.permalink.exceptions import DashboardPermalinkInvalidStateError
from axbi.dashboards.permalink.schemas import DashboardPermalinkStateSchema
from axbi.extensions import event_logger
from axbi.key_value.exceptions import KeyValueAccessDeniedError
from axbi.views.base_api import BaseAxBIApi, requires_json

logger = logging.getLogger(__name__)


class DashboardPermalinkRestApi(BaseAxBIApi):
    ...
    def post(self, pk: str) -> Response:
        ...
        try:
            ...
            url = url_for("AxBI.dashboard_permalink", key=key, _external=True)
