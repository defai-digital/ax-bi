...
from axbi.models.dashboard import Dashboard, is_uuid
from axbi.models.embedded_dashboard import EmbeddedDashboard
from axbi.models.slice import Slice
from axbi.security.guest_token import GuestTokenResourceType, GuestUser
...
from axbi.views.base import BaseFilter
from axbi.views.base_api import BaseFavoriteFilter
...
class DashboardAccessFilter(BaseFilter):  # pylint: disable=too-few-public-methods
    ...
    def apply(self, query: Query, value: Any) -> Query:
        ...
        if is_feature_enabled("EMBEDDED_AXBI") and security_manager.is_guest_user(
            g.user
        ):
