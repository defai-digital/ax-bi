...
class AxBIErrorType(StrEnum):
    """
    Types of errors that can exist within AxBI.

    Keep in sync with ax-bi-frontend/packages/ax-bi-ui-core/src/query/types/Query.ts
    """  # noqa: E501
...
ISSUE_CODES = {
    ...
    1010: _("AxBI encountered an error while running a command."),
    1011: _("AxBI encountered an unexpected error."),
...
ERROR_TYPES_TO_ISSUE_CODES_MAPPING = {
    AxBIErrorType.ADHOC_SUBQUERY_NOT_ALLOWED_ERROR: [1037],
    AxBIErrorType.BACKEND_TIMEOUT_ERROR: [1000, 1001],
    AxBIErrorType.GENERIC_DB_ENGINE_ERROR: [1002],
    AxBIErrorType.COLUMN_DOES_NOT_EXIST_ERROR: [1003, 1004],
    AxBIErrorType.TABLE_DOES_NOT_EXIST_ERROR: [1003, 1005],
    AxBIErrorType.SCHEMA_DOES_NOT_EXIST_ERROR: [1003, 1016],
    AxBIErrorType.MISSING_TEMPLATE_PARAMS_ERROR: [1006],
    AxBIErrorType.INVALID_TEMPLATE_PARAMS_ERROR: [1028],
    AxBIErrorType.RESULTS_BACKEND_NOT_CONFIGURED_ERROR: [1021],
    AxBIErrorType.DML_NOT_ALLOWED_ERROR: [1022],
    AxBIErrorType.CONNECTION_INVALID_HOSTNAME_ERROR: [1007],
    AxBIErrorType.CONNECTION_PORT_CLOSED_ERROR: [1008],
    AxBIErrorType.CONNECTION_HOST_DOWN_ERROR: [1009],
    AxBIErrorType.GENERIC_COMMAND_ERROR: [1010],
    AxBIErrorType.GENERIC_BACKEND_ERROR: [1011],
    AxBIErrorType.CONNECTION_INVALID_USERNAME_ERROR: [1012],
    AxBIErrorType.CONNECTION_INVALID_PASSWORD_ERROR: [1013],
    AxBIErrorType.CONNECTION_ACCESS_DENIED_ERROR: [1014, 1015],
    AxBIErrorType.CONNECTION_UNKNOWN_DATABASE_ERROR: [1015],
    AxBIErrorType.CONNECTION_DATABASE_PERMISSIONS_ERROR: [1017],
    AxBIErrorType.CONNECTION_MISSING_PARAMETERS_ERROR: [1018],
    AxBIErrorType.INVALID_PAYLOAD_FORMAT_ERROR: [1019],
    AxBIErrorType.INVALID_PAYLOAD_SCHEMA_ERROR: [1020],
    AxBIErrorType.INVALID_CTAS_QUERY_ERROR: [1023],
    AxBIErrorType.INVALID_CVAS_QUERY_ERROR: [1024, 1025],
    AxBIErrorType.INVALID_SQL_ERROR: [1003],
    AxBIErrorType.SQLLAB_TIMEOUT_ERROR: [1026, 1027],
    AxBIErrorType.OBJECT_DOES_NOT_EXIST_ERROR: [1029],
    AxBIErrorType.SYNTAX_ERROR: [1030],
    AxBIErrorType.RESULTS_BACKEND_ERROR: [1031, 1032, 1033],
    AxBIErrorType.CONNECTION_INVALID_PORT_ERROR: [1034],
    AxBIErrorType.ASYNC_WORKERS_ERROR: [1035],
    AxBIErrorType.DATABASE_NOT_FOUND_ERROR: [1011, 1036],
    AxBIErrorType.CONNECTION_DATABASE_TIMEOUT: [1001, 1009],
    AxBIErrorType.MARSHMALLOW_ERROR: [1040],
    AxBIErrorType.RESULT_TOO_LARGE_ERROR: [1041],
}


class ErrorLevel(StrEnum):
    """
    Levels of errors that can exist within AxBI.
