...
from axbi.exceptions import AxBIMarshmallowValidationError
from axbi.models.sql_types import parse_currency_string
...
class DatasetPutSchema(Schema):
    ...
    def handle_error(
        ...
        **kwargs: Any,
        ...
        Return SIP-40 error.
        """
        raise AxBIMarshmallowValidationError(error, data)
