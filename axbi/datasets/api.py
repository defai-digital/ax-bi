...
from axbi import event_logger, is_feature_enabled, security_manager
from axbi.commands.dataset.create import CreateDatasetCommand
from axbi.commands.dataset.delete import DeleteDatasetCommand
...
from axbi.commands.dataset.importers.dispatcher import ImportDatasetsCommand
from axbi.commands.dataset.refresh import RefreshDatasetCommand
from axbi.commands.dataset.update import UpdateDatasetCommand
...
from axbi.databases.filters import DatabaseFilter
from axbi.datasets.filters import DatasetCertifiedFilter, DatasetIsNullOrEmptyFilter
from axbi.datasets.schemas import (
...
from axbi.exceptions import AxBISyntaxErrorException, AxBITemplateException
from axbi.jinja_context import BaseTemplateProcessor, get_template_processor
from axbi.utils.core import parse_boolean_string, sanitize_cookie_token
from axbi.views.base import DatasourceFilter
...
from axbi.views.filters import BaseFilterRelatedUsers, FilterRelatedOwners

logger = logging.getLogger(__name__)


class DatasetRestApi(BaseAxBIModelRestApi):
    ...
    def render_dataset_fields(
        ...
        for item_type, key, new_key, func in items:
            ...
            except (TemplateSyntaxError, AxBISyntaxErrorException) as ex:
                template_exception = AxBITemplateException(
