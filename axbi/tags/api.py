...
from axbi.exceptions import MissingUserContextException
from axbi.extensions import event_logger
from axbi.tags.filters import UserCreatedTagTypeFilter
from axbi.tags.models import ObjectType, Tag
from axbi.tags.schemas import (
    delete_tags_schema,
...
class TagRestApi(BaseAxBIModelRestApi):
