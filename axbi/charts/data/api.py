...
from axbi.exceptions import AxBISecurityException, QueryObjectValidationError
...
from axbi.utils.decorators import logs_context
from axbi.utils.fast_cache import set_fast_cache
from axbi.utils.json_fast import dumps_fast
from axbi.views.base import CsvResponse, generate_download_headers, XlsxResponse
from axbi.views.base_api import statsd_metrics
...
class ChartDataRestApi(ChartRestApi):
    ...
    def _send_chart_response(  # noqa: C901
        ...
        if result_format in ChartDataResultFormat.table_like():
            ...
            if is_feature_enabled("GRANULAR_EXPORT_CONTROLS"):
                has_export_perm = security_manager.can_access("can_export_data", "AxBI")
            else:
                has_export_perm = security_manager.can_access("can_csv", "AxBI")
        ...
        if result_format == ChartDataResultFormat.JSON:
            ...
            # Node.js gateway (ax-bi-websocket) can serve it directly,
    ...
    def _create_streaming_csv_response(
        ...
        if not filename:
            ...
            filename = secure_filename(f"axbi_{chart_name}_{timestamp}.csv")
        else:
