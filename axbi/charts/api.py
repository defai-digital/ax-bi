...
from axbi.charts.filters import (
    ChartAllTextFilter,
...
from axbi.commands.chart.importers.dispatcher import ImportChartsCommand
...
from axbi.commands.exceptions import CommandException, TagForbiddenError
...
from axbi.utils.core import sanitize_cookie_token
...
class ChartRestApi(BaseAxBIModelRestApi):
    ...
    def cache_screenshot(self, pk: int, **kwargs: Any) -> WerkzeugResponse:
        ...
        chart_url = get_url_path("AxBI.slice", slice_id=chart.id)
    ...
    def warm_up_cache(self) -> Response:
        ...
        """  # noqa: E501
        try:
            body = ChartCacheWarmUpRequestSchema().load(
                request.get_json(cache=True, silent=True)
            )
        except ValidationError as error:
            return self.response_400(message=error.messages)
