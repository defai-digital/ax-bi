...
class UserAttribute(Model, AuditMixinNullable):
    ...
    authentication type and circular dependencies in AxBI. Instead, we use
    ...
    # is forced to log out (see ``axbi.security.session_invalidation``).
    ...
    # axbi.security.password_change when ENABLE_FORCE_PASSWORD_CHANGE is on).
