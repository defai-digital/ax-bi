...
from axbi_core.tasks.models import Task as CoreTask
from axbi_core.tasks.types import TaskProperties, TaskStatus
...
class Task(CoreTask, AuditMixinNullable, Model):
    ...
    This model represents async tasks in AxBI, providing unified tracking
