...
@click.option(
    ...
    is_flag=True,
    prompt=(
        "Are you sure you want to reset AxBI? This action cannot be undone. Continue?"
    ),
...
def factory_reset(
    ...
    from axbi.commands.security.reset import ResetAxBICommand
    ...
    try:
        ResetAxBICommand(silent, user, exclude_users, exclude_roles).run()
