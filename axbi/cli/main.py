...
from axbi import appbuilder, cli, security_manager
...
class AxBIFlaskGroup(FlaskGroup):
    def list_commands(self, ctx: click.Context) -> list[str]:
        """List registered CLI commands without loading the AxBI app.

        FlaskGroup normally loads the app while formatting top-level help so it
        can include app-provided commands. AxBI registers its CLI modules
...
def create_app() -> Any:
    ...
    from axbi.app import create_app as create_axbi_app

    return create_axbi_app()
