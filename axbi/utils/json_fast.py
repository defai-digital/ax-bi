...
from axbi.utils.dates import datetime_to_epoch, EPOCH
from axbi.utils.json import base_json_conv
...
def _orjson_default(obj: Any) -> Any:
    """Default handler for orjson that matches axbi.utils.json behavior.
...
def dumps_fast(obj: Any) -> str:
    ...
    It handles the same types as ``axbi.utils.json.dumps()`` with
