...
# under the License.
"""AxBI wrapper around pyarrow.Table."""
...
from axbi.axbi_typing import DbapiDescription, DbapiResult, ResultSetColumnType
...
def stringify_extension_columns(table: pa.Table) -> pa.Table:
    ...
    AxBI cannot render Arrow extension types natively (see
    ``axbi.utils.core.GenericDataType``). The most common case is the
...
class AxBIResultSet:
    def __init__(  # pylint: disable=too-many-locals  # noqa: C901
        ...
        if cursor_description:
            ...
            # See https://github.com/defai-digital/ax-bi/issues/23848
