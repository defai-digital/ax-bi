...
This module handles the injection of concrete AxBI implementations
into the abstract ax-bi-core API modules. This allows the core API
...
from axbi.extensions.context import get_current_extension_context

if TYPE_CHECKING:
    from axbi_core.common.models import Database
    from axbi_core.rest_api.api import RestApi
...
def inject_dao_implementations() -> None:
    """
    Replace abstract DAO classes in axbi_core common/queries/tasks daos with
    concrete implementations from AxBI.
    """
    import axbi_core.common.daos as core_common_dao_module
    import axbi_core.queries.daos as core_queries_dao_module
    import axbi_core.tasks.daos as core_tasks_dao_module

    from axbi.daos.chart import ChartDAO as HostChartDAO
    from axbi.daos.dashboard import DashboardDAO as HostDashboardDAO
    from axbi.daos.database import DatabaseDAO as HostDatabaseDAO
    from axbi.daos.dataset import DatasetDAO as HostDatasetDAO
    from axbi.daos.key_value import KeyValueDAO as HostKeyValueDAO
    from axbi.daos.query import (
        QueryDAO as HostQueryDAO,
        SavedQueryDAO as HostSavedQueryDAO,
    )
    from axbi.daos.tag import TagDAO as HostTagDAO
    from axbi.daos.tasks import TaskDAO as HostTaskDAO
    from axbi.daos.user import UserDAO as HostUserDAO
...
def inject_model_implementations() -> None:
    """
    Replace abstract model classes in axbi_core common/queries/tasks models with
    concrete implementations from AxBI.

    Uses in-place replacement to maintain single import location for extensions.
    """
    import axbi_core.common.models as core_common_models_module
    import axbi_core.queries.models as core_queries_models_module
    import axbi_core.tasks.models as core_tasks_models_module
    from flask_appbuilder.security.sqla.models import User as HostUser

    from axbi.connectors.sqla.models import SqlaTable as HostDataset
    from axbi.key_value.models import KeyValueEntry as HostKeyValue
    from axbi.models.core import Database as HostDatabase
    from axbi.models.dashboard import Dashboard as HostDashboard
    from axbi.models.slice import Slice as HostChart
    from axbi.models.sql_lab import Query as HostQuery, SavedQuery as HostSavedQuery
    from axbi.models.tasks import Task as HostTask
    from axbi.tags.models import Tag as HostTag
...
def inject_query_implementations() -> None:
    """
    Replace abstract query functions in axbi_core.queries.query with concrete
    implementations from AxBI.
    """
    import axbi_core.queries.query as core_query_module
...
def inject_task_implementations() -> None:
    """
    Replace abstract task functions in axbi_core tasks.types and tasks.decorators
    with concrete implementations from AxBI.
    """
    import axbi_core.tasks.decorators as core_tasks_decorators_module
    import axbi_core.tasks.types as core_tasks_types_module
...
def inject_rest_api_implementations() -> None:
    """
    Replace abstract REST API decorators in axbi_core.rest_api.decorators
    with concrete implementations from AxBI.
    """
    import axbi_core.rest_api.decorators as core_rest_api_module
...
def inject_model_session_implementation() -> None:
    """
    Replace abstract get_session function in axbi_core.common.models with concrete
    implementation from AxBI.
    """
    import axbi_core.common.models as core_models_module
...
def inject_semantic_layer_implementations() -> None:
    ...
    axbi_core.semantic_layers.decorators with a concrete implementation
    that registers classes in the contributions registry.
    """
    import axbi_core.semantic_layers.decorators as core_sl_module

    import axbi.extensions.context as context_module
...
def initialize_core_api_dependencies() -> None:
    """
    Initialize all dependency injections for the ax-bi-core API.

    This should be called during AxBI initialization to replace
