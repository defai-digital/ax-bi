...
class AxServicesConfig:
    """Configuration for calls from AxBI to ax-services."""
...
class AxServicesClient:
    ...
    def metadata(self, request_id: str | None = None) -> AxServicesResponse:
        """Call the sidecar AxBI metadata probe endpoint."""
    ...
    def list_annotations(
        ...
        *,
        ...
        """Call the sidecar annotation list endpoint."""
    ...
    def list_charts(
        ...
        *,
        ...
        """Call the sidecar chart list endpoint."""
    ...
    def list_datasets(
        ...
        *,
        ...
        """Call the sidecar dataset list endpoint."""
    ...
    def list_reports(
        ...
        *,
        ...
        """Call the sidecar report list endpoint."""
