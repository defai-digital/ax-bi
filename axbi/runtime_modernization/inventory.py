...
RUNTIME_INVENTORY: tuple[RuntimeInventoryItem, ...] = (
    RuntimeInventoryItem(
        ...
        module_patterns=("axbi/security", "axbi/extensions"),
        ...
        rationale=(
            ...
            "manager, and the published AxBI security model."
        ),
    ),
    RuntimeInventoryItem(
        area="metadata_models_daos",
        module_patterns=("axbi/models", "axbi/daos", "axbi/migrations"),
        current_runtime=Runtime.PYTHON,
        target_runtime=Runtime.PYTHON,
        disposition=MigrationDisposition.KEEP,
        rationale=(
            "SQLAlchemy models, DAO filters, migrations, and transaction behavior "
            "are core AxBI compatibility surfaces."
        ),
    ),
    RuntimeInventoryItem(
        area="core_commands",
        module_patterns=("axbi/commands",),
        current_runtime=Runtime.PYTHON,
        target_runtime=Runtime.PYTHON,
    ...
    RuntimeInventoryItem(
        ...
        module_patterns=("axbi/mcp_service",),
        current_runtime=Runtime.PYTHON,
    ...
    RuntimeInventoryItem(
        ...
        module_patterns=("axbi/mcp_service/ai",),
        current_runtime=Runtime.PYTHON,
        target_runtime=Runtime.TYPESCRIPT,
        disposition=MigrationDisposition.CANDIDATE,
        rationale=(
    ...
    RuntimeInventoryItem(
        ...
        module_patterns=("axbi/mcp_service/ai/asset_search.py",),
        current_runtime=Runtime.PYTHON,
        target_runtime=Runtime.TYPESCRIPT,
        disposition=MigrationDisposition.CANDIDATE,
        rationale=(
            "Derived metadata search can live outside core AxBI metadata "
            "writes while delegating authorization back to AxBI."
        ),
        required_evidence=(
            "ranking quality baseline",
            "AxBI permission delegation",
            "index freshness metrics",
        ),
    ),
    RuntimeInventoryItem(
        area="mcp_user_directory_tools",
        module_patterns=("axbi/mcp_service/user",),
        current_runtime=Runtime.PYTHON,
        target_runtime=Runtime.PYTHON,
        disposition=MigrationDisposition.DEFER,
        rationale=(
            "User-directory MCP tools expose sensitive identity metadata and do "
            "not have a general AxBI REST list API for ax-services to "
            "delegate to as the authorization and data-shape authority."
        ),
        required_evidence=(
            "general AxBI user-list API design",
    ...
    RuntimeInventoryItem(
        ...
        module_patterns=("axbi/mcp_service/chart/validation",),
        current_runtime=Runtime.PYTHON,
        target_runtime=Runtime.RUST,
        disposition=MigrationDisposition.CANDIDATE,
        rationale=(
    ...
    RuntimeInventoryItem(
        ...
        module_patterns=("axbi/utils/pandas_postprocessing",),
        current_runtime=Runtime.PYTHON,
    ...
    RuntimeInventoryItem(
        ...
        module_patterns=("axbi/reports", "axbi/tasks"),
        current_runtime=Runtime.PYTHON,
        target_runtime=Runtime.PYTHON,
        disposition=MigrationDisposition.DEFER,
        rationale=(
