...
from axbi.models.sql_lab import Query, SavedQuery
from axbi.queries.filters import QueryFilter
from axbi.queries.saved_queries.filters import SavedQueryFilter
...
class QueryDAO(BaseDAO[Query]):
    ...
    def stop_query(client_id: str) -> None:
        ...
        if not sql_lab.cancel_query(query):
            raise AxBICancelQueryException("Could not cancel query")
