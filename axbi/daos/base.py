...
from axbi_core.common.daos import BaseDAO as CoreBaseDAO
...
from axbi.constants import SKIP_VISIBILITY_FILTER_CLASSES
...
class BaseDAO(CoreBaseDAO[T], Generic[T]):
    ...
    def find_by_id_or_uuid(
        ...
        *,
        ...
        if model_id_or_uuid.isascii() and model_id_or_uuid.isdecimal():
